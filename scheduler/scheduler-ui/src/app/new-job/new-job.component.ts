...
export class NewJobComponent implements OnInit {
  ...
  ngOnInit(): void {
   ...
   this.enableCron = this.data.cron_enabled;
...
//Class Type
      let httpGroup: { jobName: String, starturl: String, stopurl: String , enableCron : boolean} = this.newJobForm.controls['urlGroup'].value;
      httpGroup.enableCron = this.enableCron;
console.log(httpGroup)
      ...
      let classJob :{jobName:String , startMethod:String , stopMethod:String , classPath:String ,parameters : String , enableCron : boolean} = this.newJobForm.controls['classGroup'].value;
      classJob.enableCron = this.enableCron;
      console.log(classJob)
      this._service.postClassJob(classJob).subscribe(result => {
        if (result.statusCode == ServerResponseCode.SUCCESS) {
          this.success = true;
  ...
  onUpdate() {
    ...
    if (this.typeOfJob == false) {
      ...
      let jobData: { jobName: String, starturl: String, stopurl: String, enableCron: boolean } = this.updateForm.controls['urlGroup'].value;
      jobData.jobName = this.updateForm.controls['urlGroup'].get("jobName").value;
      jobData.enableCron = this.enableCron;
      console.log(jobData)
  ...
  onChange(){
    this.enableCron = !this.enableCron;
  }
