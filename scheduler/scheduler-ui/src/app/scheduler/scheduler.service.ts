...
export class SchedulerService {
  ...
  getSpecialJobsUrl = "GetSpecialJobs";
  stopJobUrl = "stop";
  ...
  stopSpecialJoburl = 'stopSpecialJob';
  ...
  updateHttpJob(jobData): Observable<Job> {
  ...
  autoLogin() {
   ...
   getSpecialJobs():Observable<{statusCode:number,data :{jobName:string,status:boolean,time:Date} []}>{
      return this._http.get<{statusCode:number,data :{jobName:string,status:boolean,time:Date} []}>(this.getSpecialJobsUrl);
   }

   stopSpecialJob(jobName:string):Observable<{statusCode:number,data:boolean}>{
   return  this._http.get<{statusCode:number,data:boolean}>(this.stopSpecialJoburl,{params:new HttpParams().append("jobName",jobName)});
   }
